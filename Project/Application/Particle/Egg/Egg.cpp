...
void EggParticle::Initialize(ID3D12Device* device, ID3D12GraphicsCommandList* commandList, ID3D12RootSignature* rootSignature, ID3D12PipelineState* pipelineState,
...
void EggParticle::Draw(ID3D12GraphicsCommandList* commandList, BaseCamera& camera)
{
...
void EggParticle::UAVBufferInitialize(ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
{
...
void EggParticle::ConstantBufferInitialzie(ID3D12Device* device)
{
...
void EggParticle::InitialzieCS(ID3D12GraphicsCommandList* commandList)
{
...
void EggParticle::Emit(ID3D12GraphicsCommandList* commandList)
{
...
void EggParticle::UpdateCS(ID3D12GraphicsCommandList* commandList)
{
...
void EggParticle::SetEmitter(const EmitBlendNormalCS& emitter, bool isEmitSet)
{
...
void EggParticle::PipelineStateCSInitializeForInitialize(ID3D12Device* device)
{
...
void EggParticle::PipelineStateCSInitializeForEmit(ID3D12Device* device)
{
...
void EggParticle::PipelineStateCSInitializeForUpdate(ID3D12Device* device)
{
