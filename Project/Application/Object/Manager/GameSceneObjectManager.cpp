...
void GameSceneObjectManager::PlayerInitialize()
{
	...
	AddObject("InteractionSpot", "PickArmorSpot", sVehiclePaths[VehicleDatas::kArmor].first, sVehiclePaths[VehicleDatas::kArmor].second);
	AddObject("InteractionSpot", "PickEngineSpot", sVehiclePaths[VehicleDatas::kEngine].first, sVehiclePaths[VehicleDatas::kEngine].second);
	AddObject("InteractionSpot", "PickTireSpot", sVehiclePaths[VehicleDatas::kTire].first, sVehiclePaths[VehicleDatas::kTire].second);
	//// 場所用のインタラクトオブジェクト
	...
	// 3種類登録
	std::vector<std::pair<std::string, InteractionSpot*>> spots = {
		{static_cast<InteractionSpot*>(this->GetObjectPointer("ArmorSpot"))->GetName(),static_cast<InteractionSpot*>(this->GetObjectPointer("ArmorSpot"))},
	...
	std::vector<std::pair<std::string, InteractionSpot*>> pickSpots = {
	{static_cast<InteractionSpot*>(this->GetObjectPointer("PickArmorSpot"))->GetName(),static_cast<InteractionSpot*>(this->GetObjectPointer("ArmorSpot"))},
	{static_cast<InteractionSpot*>(this->GetObjectPointer("PickEngineSpot"))->GetName(),static_cast<InteractionSpot*>(this->GetObjectPointer("EngineSpot"))},
	{static_cast<InteractionSpot*>(this->GetObjectPointer("PickTireSpot"))->GetName(),static_cast<InteractionSpot*>(this->GetObjectPointer("TireSpot"))}
	};

	player_->GetPickUpManager()->SpotSetup(spots, pickSpots);
